...
import time
from app.imageDownloader import img_download
from app.api import API
from webdriver_manager.chrome import ChromeDriverManager
from selenium.webdriver.chrome.options import Options

from app.imageScraper import scrape_images



def scrape_text(query,api:API):
        ...
        try: # scraping all the lists from "People also ask"
            ...
            try: # scraping is done from "People also ask"
                ...
                for x in data:
                    ...
                    related_list.append(x.get_text().strip())
                    print(related_list)
                    api.template_information(path,query,related_list)
                    related_list.clear()
                    del api
                    return "null"
            except:
                driver.quit()
                api.send_text("Sorry couldn't find anything. I am still learning📖\nTry asking similar queries🤔")
                del api
                return "null"
